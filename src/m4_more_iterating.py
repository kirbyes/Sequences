...
def run_test_count_items_bigger_than():
    ...
    # Test 10:
    sequence = [7857, 6557, 756, 65, 764, 4243, 54321]
    threshold = 765
    expected = 4
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 7
    actual = count_positive_sines([8, 3, 3, 1, 7, 8, 9])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 107
    actual = sum_first_n([98, 9, 397, 237473], 2)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 97425
    actual = sum_first_n([97425, 984, 9834], 1)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
